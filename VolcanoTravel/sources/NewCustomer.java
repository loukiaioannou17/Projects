...
public class NewCustomer extends javax.swing.JFrame {
    ...
    public NewCustomer(Connection con,Caller c,CompanyManager cm,int id) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt,Connection con,Caller c,CompanyManager cm,int id) {                                            
        try{
        	...
        	Date d = new Date();
        	out.append("Time = "+d.toString() + " Employee id "+ id+" Added a new customer \n");
        	stmt.execute("DECLARE @count int\nSELECT TOP 1 @count = CustomerID From Customer ORDER BY CustomerID DESC\nSET @count = @count +1\nINSERT INTO Customer VALUES(@count,'"+jTextField2.getText()+"','"+jTextField5.getText()+"','"+jTextField1.getText()+"','"+jTextField4.getText()+"',"+jTextField3.getText()+")");

...
public class SearchHotel extends javax.swing.JFrame {
     ...
     */
    public SearchHotel(Connection con,Caller c,CompanyManager cm,int id) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt,Connection con,Caller c,CompanyManager cm,int id) {                                         
    	String query = "SELECT Hotels.NumberOfRooms,Hotels.Name FROM lioann02.Hotels,(SELECT I.Island_ID,I.Name FROM ISLANDS I WHERE I.Name ='"+jTextField1.getText()+"' ) AS temp WHERE IslandID=temp.Island_ID";
    	try {

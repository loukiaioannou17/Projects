...
public class SearchFlight extends javax.swing.JFrame {
    ...
    public SearchFlight(Connection con,Caller c,CompanyManager cm,int id) {
    ...
    private void initComponents(Connection con,Caller c,CompanyManager cm,int id) {
        ...
        jLabel5.setText("MinPrice");

        jLabel6.setText("MaxPrice");
...
//otan vazeis arrival vazeis 09:12
ResultSet s = stmt.executeQuery("SELECT F.DiscountPrice FROM lioann02.Flights F WHERE F.Arrival='"+jTextField1.getText()+"' AND F.Departure='"+jTextField3.getText()+"' AND f.ArrivalTime='"+jTextField2.getText()+"' AND f.Price>"+jTextField5.getText()+"AND f.Price<"+jTextField4.getText());
String label = " ";
while (s.next()){
